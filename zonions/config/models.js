...
module.exports.models = {
  ...
  ***************************************************************************/
  ...
  //for getting created and updated time in local string formal
  ...
  beforeUpdate: function (values, next) {
    ...
    else if (values.updatedAt == 'no_update'){
  ...
  beforeCreate: function (values, next) {
    if (!values.updatedAt) values.updatedAt = new Date().toLocaleString();

    else values.updatedAt = new Date(values.updatedAt).toLocaleString();

    if (!values.createdAt) values.createdAt = new Date().toLocaleString();

    else values.createdAt = new Date(values.createdAt).toLocaleString();
  ...
  ******************************************************************************/
  ...
  dataEncryptionKeys: {
    default: 'm57PYFutxqfMnAULGNAZCGSRIFZ2wLrKMbPGhpM0Lwk='
  },
